...
#
echo "[lawn-Kernel] Boot Script Started" | tee /dev/kmsg
stop mpdecision

############################
# INTELLI_Hotplug Settings
#
echo 853 > /sys/module/intelli_plug/parameters/cpu_nr_run_threshold 
echo 1 > /sys/module/intelli_plug/parameters/intelli_plug_active    
echo 7 > /sys/module/intelli_plug/parameters/nr_run_hysteresis
...
echo zzmoove > /sys/kernel/msm_limiter/scaling_governor_0
echo zzmoove > /sys/kernel/msm_limiter/scaling_governor_1
echo zzmoove > /sys/kernel/msm_limiter/scaling_governor_2
echo zzmoove > /sys/kernel/msm_limiter/scaling_governor_3
...
echo "[lawn-Kernel] disable debug mask" | tee /dev/kmsg
...
echo "[lawn-Kernel] Boot Script Completed!" | tee /dev/kmsg
